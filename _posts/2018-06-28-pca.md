...
Thus, If we take $$W$$ as the matrix of the eigenvalues and $$C_Y$$ as the diagonal matrix of the eigenvalues, the above equation will hold true, making the matrix $$W$$, of eigenvectors of covariance of $$X$$, our transformation matrix.
...
![pca_data](/images/PCA/pca_data.png)
